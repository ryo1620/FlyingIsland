...
namespace GoogleMobileAds.Unity
{
    ...
    public class RewardingAdBaseClient : BaseAdDummyClient
    {
        ...
        internal void CreateButtonBehavior()
        {
            ...
            // 以下3行はエラー回避のため独自に追加（参照：https://www.youtube.com/watch?v=J-C2A__oAp4&ab_channel=MuratTatar）
            GameObject go = new GameObject();
            go.AddComponent<ButtonBehaviour>();
            buttonBehaviour = go.GetComponent<ButtonBehaviour>();
        }
